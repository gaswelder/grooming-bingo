...
const maps = {
  ...
  ztn3tourney1: "https://lvlworld.com/levels/ztn3tourney1/ztn3tourney1lg.jpg",
  cs_assault:
...
const random = xs => xs[Math.round(Math.random() * xs.length - 1)];
