module.exports = class State {
  ...
  /**
   * Applies a change command as emitted by the emit function.
   *
   * @param {[string, array, any]} changeCommand
   */
  apply(changeCommand) {
    const [op, path, val] = changeCommand;
    const f = { push, set, del };
    this.state = f[op](this.state, path, val);
  }
